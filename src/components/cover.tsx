    ...
    return (
        <section className="w-full h-[100dvh] justify-items-center lg:py-32 py-12">
            ...
            lg:dark:drop-shadow-[0_0_5px_rgba(0,0,255,0.5)] dark:drop-shadow-[0_0_10px_rgba(0,0,255,0.7)] dark:brightness-125">
                ...
                <span className="cursor-default flex place-items-center dark:text-purple-700 gap-0 hover:gap-2 text-xl transition-all duration-500 hover:brightness-125 hover:drop-shadow-[0_0_10px_rgba(0,0,255,0.9)]">
                    <h2>Software</h2>
                    <Star />
                    <h2>Engineer</h2>
                </span>
            ...
            <div className="flex flex-wrap gap-3 sm:mx-16 justify-center overflow-visible mt-4">
                {skills.map((skill, index) => (
                    <span key={index} >
                        <div onMouseEnter={() => setHover(index)} onMouseLeave={() => setHover(null)} className="w-auto flex gap-2 mx-[0.1vh] hover:mx-0 items-center lg:text-lg md:text-md text-sm items-center px-4 dark:bg-[#111111] bg-[#d1gfff] relative rounded-lg p-2 hover:scale-110 transition-all duration-500 
                    group transform origin-center justify-items-center sm:min-w-[130px] dark:border-none border-1 border-black">
