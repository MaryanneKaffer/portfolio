...
export default function CreditFooter() {
    ...
    return (
        <footer className="flex flex-col items-center p-5">
            <div className="min-h-[50px] sm:mt-0 mt-10 relative flex place-items-center justify-center gap-2 dark:hover:brightness-125 hover:brightness-90 transition-all">
                <h1 className="text-center text-md">Powered by <a href="https://github.com/MaryanneKaffer" target="_blank" className="dark:text-purple-900 text-pink-500 hover:brightness-125 transition-all hover:drop-shadow-[0_0px_8px_rgba(255,192,203,0.5)]">Maryanne Käffer</a></h1>
