...
export default function Academic() {
    ...
    return (
        <section className="w-full lg:h-[40dvh] ml-12 relative lgxl:mt-[100px] lg:mt-[200px] xl:mt-[150px] md:mt-[40px] mt-[100px]">
            <motion.div transition={{ type: "spring", stiffness: 60, damping: 20, }} className="absolute h-full w-full -mt-[70px] ">
                ...
                <div className={`w-[3px] lg:-ml-[23px] -ml-[32px] rounded-b-xl bg-gradient-to-b from-black/100 to-black/0 dark:from-white/100 dark:to-white/0 bg-black ${active ? "h-[80%]" : "h-0"} transition-all duration-1000`} />
            </motion.div>
            <div className={`${active ? "opacity-100" : "opacity-0"} transition-all duration-1000`}>
                <h1 className="sm:text-4xl text-2xl lg:mb-10 mt-5 mb-3">Academic</h1>
